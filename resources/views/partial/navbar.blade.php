 <!-- Navbar -->
 <nav class="main-header navbar navbar-expand navbar-main navbar-light text-white">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li>
        <a  data-toggle="dropdown" href="#">
            <div class="image">
                <img width="40px" src="{{asset('Admin/dist/img/user2-160x160.jpg')}}" class="img-circle elevation-2" alt="User Image">
            </div>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <div class="dropdown-divider"></div>
            <a href="#" class="dropdown-item">
              <i class="fas fa-envelope mr-2"></i> Thông tin mẫu
