       ...
       <table class="table table-striped table-dark">
          ...
          <tbody>
             <tr>
                ...
                <td><img width="80" src="{{$detailEmployee['img_cover']}}" alt="{{$detailEmployee['img_cover']}}"></td>
    ...
    <div class="row">
       ...
       <div class="col-12">
          <div class="card">
                   ...
                   <div class="row">
                      <div class="col">
                         <div class="card-header-left  d-flex align-items-end justify-content-center">
                            <button type="button" data-toggle="modal" data-target="#modal-add-employee" class="btn btn-sm btn-info ml-auto"><i class="fas fa-edit"></i>Thêm nhân viên</button>
                         </div>
                      </div>
                      <div>
                ...
                <table class="table table-head-fixed text-nowrap">
                   ...
                   <tbody>
                      ...
                      <tr>
                         ...
                         <td><img width="80" src="{{$employees['img_cover']}}" alt="{{$employees['img_cover']}}"></td>
                        ...
                        <div class="height d-flex justify-content-center align-items-center"> <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"> View</button> </div>
             </div>
             <!-- Modal -->
             ...
             {{-- <a class="btn btn-primary  btn-xs" wire:click="detailEmployee({{$employees['code_employee']}})" data-toggle="modal" data-target="#modal-detail-employee" href="/employee/{{$employees->code_employee}}">
